...
//
// SYNC BY HAND: this file must be kept identical to the scaffold-template twin
// (codexPermissionGuardMjsTemplate() in src/scaffold/shared/claude-setup.ts). This guard is
