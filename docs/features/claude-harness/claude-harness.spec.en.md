...
keywords: [claudesetup, harness, aiharnesssetup, buildclaudefilemap, agents, agentregistry, skills, backlog, parkrule, plans, validator]
updated: 2026-06-20
---
...
## Key Decisions
- Parameter object over inheritance/abstraction for project types — only ~10 fields, no project-type registry.
